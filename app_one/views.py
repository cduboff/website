...
def create(request):
    ...
    print(requests.get(f'https://api.spoonacular.com/mealplanner/{user.user_id.username}/templates/391?apiKey={secret.api_key}', json={'username': user.user_id.username, 'hash': user.user_id.hash}).json())
    # print(new_plan)
    # print(plan)
    # print(specific)
    context = {
